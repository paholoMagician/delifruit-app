...
@Component({
  selector: 'app-cont-devolucion',
  templateUrl: './cont-devolucion.component.html',
  styleUrls: ['./cont-devolucion.component.css']
})
export class ContDevolucionComponent implements OnInit {
  public show = false;
  ...
  constructor(private dns: DevsobcontrolService) { }
