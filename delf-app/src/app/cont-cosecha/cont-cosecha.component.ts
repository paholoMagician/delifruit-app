...
@Component({
  selector: 'app-cont-cosecha',
  templateUrl: './cont-cosecha.component.html',
  styleUrls: ['./cont-cosecha.component.css']
})
export class ContCosechaComponent implements OnInit {
  loadingadd = false
  ...
  constructor(private service:CosechacontrolService) { }
